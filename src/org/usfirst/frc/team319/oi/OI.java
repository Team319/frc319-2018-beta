...
public class OI {
	...
	public BobController driverController = new BobController(0);
	
	public OI() {
		driverController.leftStickButton.whileHeld(new ShiftDownCommand());
		driverController.leftStickButton.whenReleased(new ShiftUpCommand());
	}
